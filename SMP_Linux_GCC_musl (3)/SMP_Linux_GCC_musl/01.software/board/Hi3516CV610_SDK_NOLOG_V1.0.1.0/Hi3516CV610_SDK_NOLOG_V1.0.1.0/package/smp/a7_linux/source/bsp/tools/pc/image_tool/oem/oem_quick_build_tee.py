...
key_list = [
        ...
        ["TEE_root", "TEE_root_private_key", "TEE_root_pub_key"],
        ...
        ["TEEOS_external", "TEEOS_external_private_key", "TEEOS_external_public_key"]
        ]

config_file = "./oem/quick_build_tee_config.json"
