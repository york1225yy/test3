...
#define SAMPLE_SVP_VB_POOL_NUM     1
 ...
 * Start Vpss
 */
td_s32 sample_common_svp_create_vb_start_vpss(ot_sample_svp_media_cfg *media_cfg);
/*
 * Stop Vpss
 */
td_void sample_common_svp_destroy_vb_stop_vpss(ot_sample_svp_media_cfg *media_cfg);
/*
 * Send stream to venc
 */
td_s32 sample_common_svp_venc_send_stream(const ot_sample_svp_switch *venc_switch,
    ot_venc_chn venc_chn, const ot_video_frame_info *frame);

td_s32 sample_common_svp_npu_start_vi_vpss_venc(sample_vi_cfg *vi_cfg, ot_sample_svp_media_cfg *media_cfg);

td_void sample_common_svp_destroy_vb_stop_vi_vpss_venc(sample_vi_cfg *vi_cfg, ot_sample_svp_media_cfg *media_cfg);
#ifdef __cplusplus
#if __cplusplus
}
#endif
