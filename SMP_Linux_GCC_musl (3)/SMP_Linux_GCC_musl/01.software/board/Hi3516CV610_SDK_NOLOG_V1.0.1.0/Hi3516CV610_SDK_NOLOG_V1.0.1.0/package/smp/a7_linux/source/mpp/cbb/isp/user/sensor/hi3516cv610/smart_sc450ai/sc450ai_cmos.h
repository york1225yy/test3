...
/* linear mode */
#define SC450AI_FULL_LINES_MAX_LINEAR 0x79E0
#define SC450AI_VMAX_VAL_LINEAR 1560         /* linear init sequence e.g. 0x380e, 0x06, 0x380f, 0x58 */
#define SC450AI_VMAX_LINEAR     (SC450AI_VMAX_VAL_LINEAR + SC450AI_INCREASE_LINES)
#define SC450AI_FPS_MAX_LINEAR 30
#define SC450AI_FPS_MIN_LINEAR 1.5
#define SC450AI_WIDTH_LINEAR 2688
#define SC450AI_HEIGHT_LINEAR 1520
#define SC450AI_MODE_LINEAR 0

/* WDR mode */
#define SC450AI_FULL_LINES_MAX_2TO1_LINE_WDR 0x2490
#define SC450AI_VMAX_VAL_2TO1_LINE_WDR 3120         /* WDR init sequence 0x380e, 0x09, 0x380f, 0x84 */
#define SC450AI_VMAX_2TO1_LINE_WDR   (SC450AI_VMAX_VAL_2TO1_LINE_WDR + SC450AI_INCREASE_LINES)
#define SC450AI_FPS_MAX_2TO1_LINE_WDR 30
#define SC450AI_FPS_MIN_2TO1_LINE_WDR 10.0
#define SC450AI_WIDTH_2TO1_LINE_WDR 2688
#define SC450AI_HEIGHT_2TO1_LINE_WDR 1520
#define SC450AI_MODE_2TO1_LINE_WDR 0
#define SC450AI_EXP_Y 0x5FF
...
#define SC450AI_AGAIN_MAX    61976
...
#define ISP_DGAIN_TARGET_WDR_MAX  2

#define FL_OFFSET_LINEAR                   10
#define FL_OFFSET_WDR                      18
#define SFL_OFFSET_WDR                     11
#define SC450AI_SEXP_MAX_DEFAULT           16
 /****************************************************************************
...
ot_isp_sns_obj *sc450ai_get_obj(td_void);
