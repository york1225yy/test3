...
static td_u32 sample_comm_vi_calc_pipe_pixel_rate(td_u32 lane_rate, td_u32 lane_num, td_u32 bit_num, td_u32 wdr_num)
{
...
static td_u32 sample_comm_vi_get_sensor_pixel_rate_by_type(sample_sns_type sns_type)
{
    td_u32 pixel_rate = 0;
    switch (sns_type) {
...
td_s32 sample_comm_vi_set_mipi_hs_mode(lane_divide_mode_t hs_mode)
{
    td_s32 fd;
    td_s32 ret;
...
td_s32 sample_comm_vi_mipi_ctrl_cmd(td_u32 devno, td_u32 cmd)
{
    td_s32 ret;
    td_s32 fd;
...
td_s32 sample_comm_vi_start_sensor(const sample_sns_info *sns_info, const sample_mipi_info *mipi_info)
{
    td_s32 ret;
...
td_void sample_comm_vi_stop_mipi_rx(const sample_sns_info *sns_info, const sample_mipi_info *mipi_info)
{
    td_s32 ret;
...
static td_s32 sample_comm_vi_set_pipe_pixel_rate(ot_vi_pipe vi_pipe, td_u32 pixel_rate)
{
    ot_vi_vpss_mode vi_vpss_mode;
...
static td_s32 sample_comm_vi_init_one_pipe(ot_vi_pipe vi_pipe, const sample_vi_pipe_info *pipe_info)
{
    td_s32 ret;
...
{
    td_s32 ret = sample_comm_vi_init_one_pipe(vi_pipe, pipe_info);
    if (ret != TD_SUCCESS) {
        return TD_FAILURE;
    }
...
td_s32 sample_comm_vi_start_isp(const sample_vi_cfg *vi_cfg)
{
    td_s8 i, j;
    td_s32 ret;
    ot_vi_pipe vi_pipe;
...
td_void sample_comm_vi_stop_isp(const sample_vi_cfg *vi_cfg)
{
    td_u32     i;
    td_bool    start_pipe;
    ot_vi_pipe vi_pipe;
...
static td_s32 sample_comm_vi_read_user_frame_file(ot_vi_pipe vi_pipe, sample_vi_user_frame_info *user_frame_info)
{
    td_s32 ret;
    FILE *pfd = TD_NULL;
    const td_char *frame_file = "./UsePic_2560x1440_sp420.yuv";
    ot_size frame_size = {WIDTH_2560, HEIGHT_1440};
