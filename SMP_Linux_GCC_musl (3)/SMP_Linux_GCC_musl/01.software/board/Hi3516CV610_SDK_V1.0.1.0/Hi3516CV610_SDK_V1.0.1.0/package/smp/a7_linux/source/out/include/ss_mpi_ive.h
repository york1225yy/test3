...
/*
 *   Prototype    : ss_mpi_ive_get_perspective_transform
 *   Description  : Get perspective transform
 *   Parameters   : ot_svp_src_img              *src           The input source.Only the U8C1/YUVSP420/YUVSP422.
 *                                                             input format is supported.
 *                  ot_svp_rect_u32             roi[]          Roi array.
 *                  ot_ive_warp_perspective_points points[]    Point pair array.
 *                  ot_svp_src_mem_info         inverse_matrix Inverse matrix.
 *                  ot_svp_dst_img              dst[]          Output result.Only the U8C1/YUVSP420/YUVSP422
 *                                                             format is supported.
 *                  ot_ive_warp_perspective_transform_ctrl*ctrl   Perspective transform control parameter.
 *   Return Value : TD_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2024-03-05
 *   Author       : Multimedia software (SVP) group
 */
td_s32 ss_mpi_ive_get_perspective_transform(const ot_svp_src_img  *src, const ot_svp_rect_u32 roi[],
    const ot_ive_warp_perspective_points points[],  const ot_svp_dst_mem_info *inverse_matrix,
    const ot_ive_warp_perspective_transform_ctrl *ctrl);
/*
 *   Prototype    : ss_mpi_ive_warp_perspective
 *   Description  : Perspective transform
 *   Parameters   : ot_ive_handle               *handle        Returned handle ID of a task.
 *                  ot_svp_src_img              *src           The input source.Only the U8C1/YUVSP420/YUVSP422
 *                                                             input format is supported..
 *                  ot_svp_rect_u32             roi[]          Roi array.
 *                  ot_svp_src_mem_info         inverse_matrix Inverse matrix.
 *                  ot_svp_dst_img              dst[]          Output result.Only the U8C1/YUVSP420/YUVSP422
 *                                                             format is supported.
 *                  ot_ive_warp_perspective_ctrl*ctrl          PerspTrans control parameter.
 *                  td_bool                     is_instant     For details, see ss_mpi_ive_dma.
 *   Return Value : TD_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2024-03-05
 *   Author       : Multimedia software (SVP) group
 */
td_s32 ss_mpi_ive_warp_perspective(ot_ive_handle *handle, const ot_svp_src_img *src,
    const ot_svp_rect_u32 roi[], const ot_svp_src_mem_info *inverse_matrix,
    const ot_svp_dst_img dst[], const ot_ive_warp_perspective_ctrl *ctrl, td_bool is_instant);
/*
...
/*
 *   Prototype    : ss_mpi_ive_alpha_blending
 *   Description  : Two gray images Add operation by each pixel weight.
 *   Parameters   : ot_ive_handle        *handle     Returned handle ID of a task
 *                  ot_svp_src_img       *src1       Augend of the input source.Only the U8C1 input format is supported.
 *                  ot_svp_src_img       *src2       Addend of the input source.Only the U8C1 input format is supported.
 *                  ot_svp_src_img       *alpha      Weight.Only the U8C1 input format is supported.
 *                  ot_svp_dst_img       *dst        Output result of src1 plus src2.
 *                  td_bool              is_instant    For details, see ot_mpi_ive_dma.
 *   Return Value : TD_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2024-03-05
 *   Author       : Multimedia software (SVP) group
 */
td_s32 ss_mpi_ive_alpha_blending(ot_ive_handle *handle, const ot_svp_src_img *src1, const ot_svp_src_img *src2,
    const ot_svp_src_img *alpha, const ot_svp_dst_img *dst, td_bool is_instant);
 
/*
 *   Prototype    : ss_mpi_ive_acc
 *   Description  : Two gray images accumulation operation.
 *   Parameters   : ot_ive_handle        *handle     Returned handle ID of a task
 *                  ot_svp_src_img       *src1       Augend of the input source.Only the U8C1 input format is supported.
 *                  ot_svp_src_img       *src2       Addend of the input source.Only the U8C1 input format is supported.
 *                  ot_svp_dst_img       *dst        Output result of src1 plus src2.
 *                  ot_ive_acc_ctrl      *ctrl       ctrl.
 ...
 *   Author       : Multimedia software (SVP) group
 */
td_s32 ss_mpi_ive_acc(ot_ive_handle *handle, const ot_svp_src_img *src1, const ot_svp_src_img *src2,
    const ot_svp_dst_img *dst, const ot_ive_acc_ctrl *ctrl, td_bool is_instant);
 
/*
 *   Prototype    : ss_mpi_ive_image_dot
 *   Description  : Two images dot product operation.
 *   Parameters   : ot_ive_handle    *handle Returned handle ID of a task
 *                  ot_svp_src_img   *src1  Augend of the input source.Only the S32C1(s17q15) input format is supported.
 *                  ot_svp_src_img   *src2  Addend of the input source.Only the S32C1(s17q15) input format is supported.
 *                  ot_svp_dst_img   *dst   Output result of src1 multiply src2.
 *                  ot_ive_acc_ctrl  *ctrl  ctrl.
 ...
 *   Author       : Multimedia software (SVP) group
 */
td_s32 ss_mpi_ive_image_dot(ot_ive_handle *handle, const ot_svp_src_img *src1, const ot_svp_src_img *src2,
    const ot_svp_dst_img *dst, const ot_ive_image_dot_ctrl *ctrl, td_bool is_instant);
#ifdef __cplusplus
}
#endif
