...
1.download alsa-lib source code
	...
	Download the source code of alsa-lib v1.2.7 from the alsa-project open source community:
	...
	3) Download alsa-lib-1.2.7.tar.bz2

2.compile alsa-lib
	1) Store the downloaded alsa-lib-1.2.7.tar.bz2 in the smp/a7_linux/source/mpp/sample/uvc_app/alsa/opensource directory.
	2) In the linux server, enter the smp/a7_linux/source/mpp/sample/uvc_app/alsa/opensource directory and execute the following command:
	tar -xjvf alsa-lib-1.2.7.tar.bz2
	cd ./alsa-lib-1.2.7/
	mkdir -p /home/install/alsa-lib-1.2.7/
	./configure --host=arm-v01c02-linux-musleabi --prefix=/home/install/alsa-lib-1.2.7/ --enable-static=no --enable-shared=yes --with-configdir=/home/audio/alsa/ --disable-python
	make
	make install
	cp -r /home/install/alsa-lib-1.2.7/lib/ ../../
	cp -r /home/install/alsa-lib-1.2.7/include/ ../../
...
3.install to the embedded platform
	...
	1) Copy the libasound.so.2 file in the /home/install/alsa-lib-1.2.7/lib/ directory on the server to the /lib/ directory on the board.
