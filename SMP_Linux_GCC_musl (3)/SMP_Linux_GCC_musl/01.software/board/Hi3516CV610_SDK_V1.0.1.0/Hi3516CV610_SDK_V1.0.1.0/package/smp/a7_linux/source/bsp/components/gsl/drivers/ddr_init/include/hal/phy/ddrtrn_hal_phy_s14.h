...
#define DDR_PHY_ACIOCTL_SR1     0x10f8 /* AC SR port controlregister */
typedef union {
	struct {
		unsigned int reserved1 : 8;          /* [7:0] */
		unsigned int acctl_trim_res_rg : 5;  /* [12:8] */
		unsigned int reserved2 : 4;          /* [16:13] */
		unsigned int acctl_trim_res1_rg : 5; /* [21:17] */
		unsigned int reserved3 : 10;         /* [31:22] */
	} bits;
	unsigned int val;
} ddr_phy_acioctl_sr1_desc;
