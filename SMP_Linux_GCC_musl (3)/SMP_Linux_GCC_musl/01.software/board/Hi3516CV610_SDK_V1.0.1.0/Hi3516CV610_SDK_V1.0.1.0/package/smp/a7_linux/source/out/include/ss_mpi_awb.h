...
td_s32 ss_mpi_isp_set_color_sector_attr(ot_vi_pipe vi_pipe, const ot_isp_color_sector_attr *sector_attr);
td_s32 ss_mpi_isp_get_color_sector_attr(ot_vi_pipe vi_pipe, ot_isp_color_sector_attr *sector_attr);
